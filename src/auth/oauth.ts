...
function pairingPage(opts: {
  ...
  const scopeLabels: Record<string, string> = {
    ...
    "execution.read": "Read OMP execution summaries",
...
<div class="card">
  ...
  <p class="hint">The pairing code was generated by OMP on this computer.<br>It expires in a few minutes.</p>
</div>
</body>
</html>`;
}
  ...
  router.post("/oauth/authorize", urlencoded({ extended: false }), (req, res) => {
    ...
    if (!verdict.ok) {
      const messages: Record<string, string> = {
        ...
        expired: "This pairing code has expired. Ask OMP to generate a new one.",
        too_many_attempts: "Too many incorrect attempts. Ask OMP to generate a new pairing code.",
        rate_limited: "Too many attempts. Please wait a minute and try again.",
        no_active_session: "No active pairing session. Ask OMP to generate a pairing code.",
      };
