...
describe("connectorAction", () => {
  ...
  it("updates when the old address was reclaimed", () => {
    ...
    expect(reclaimUserMessage("OMP with ChatGPT")).toContain("删除");
    expect(reclaimUserMessage("OMP with ChatGPT")).not.toContain("Reconnect");
  });
